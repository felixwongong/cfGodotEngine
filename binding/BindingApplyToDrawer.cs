...
namespace cfGodotEngine.Binding
{
    ...
    public partial class BindingApplyToDrawer : CustomPropertyDrawer
    {
        ...
        protected override void _BuildNode(PropertyHint hintType, string hintString)
        {
            ...
            {
                SizeFlagsHorizontal = SizeFlags.ExpandFill,
                placeHolderText = "Select property or method...",
            };
        ...
        private void RefreshProperties()
        {
            ...
            _dropdown.Clear();
            foreach (var name in GetTargetProperties())
        ...
        private IEnumerable<string> GetTargetProperties()
        {
            var editedObject = GetEditedObject();
            if (editedObject is Binding binder)
                return binder.GetAvailableApplyTargets();
